...
if (count($session) !== 0) {
	...
	exec("tmux new-window -t $tmux_session:3 -n rutorrent-3 'rtorrent -n -o http_capath=~/certs -o import=~/.rtorrent-3.rc'");
	exec("tmux new-window -t $tmux_session:4 -n rutorrent-4 'rtorrent -n -o http_capath=~/certs -o import=~/.rtorrent-4.rc'");
